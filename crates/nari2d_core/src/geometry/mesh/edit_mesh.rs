...
use crate::{
    geometry::mesh::indices::{FaceId, HalfEdgeId, PointId},
    geometry::Point2d,
};
...
#[derive(Copy, Clone, Debug, Default, Ord, PartialOrd, Eq, PartialEq)]
pub struct Edge {
    pub point0: Option<PointId>,
    pub point1: Option<PointId>,
    pub triangle0: Option<PointId>,
    pub triangle1: Option<PointId>,
}

// based off of https://www.cs.cmu.edu/~quake/tripaper/triangle2.html
#[derive(Clone, Debug, Default)]
pub struct NariMesh {
    points: SlotMap<PointId, Point>,
    triangles: SlotMap<TriangleId, Triangle>,
    edges: SlotMap<HalfEdgeId, HalfEdge>,
