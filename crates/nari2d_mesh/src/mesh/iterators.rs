...
use crate::{
    mesh::{connectivity_info::ConnectivityInfo, ids::*, traversal::Walker, Mesh},
...
pub struct VertexHalfedgeIter<'a, P: TwoDimensionalPoint> {
    walker: Walker<'a, P>,
    start: HalfEdgeID,
    is_done: bool,
}

impl<'a, P: TwoDimensionalPoint> VertexHalfedgeIter<'a, P> {
    pub(crate) fn new(
        vertex_id: VertexID,
        connectivity_info: &'a ConnectivityInfo<P>,
    ) -> VertexHalfedgeIter<'a, P> {
...
impl<'a, P: TwoDimensionalPoint> Iterator for VertexHalfedgeIter<'a, P> {
...
pub struct FaceHalfedgeIter<'a, P: TwoDimensionalPoint> {
    walker: Walker<'a, P>,
    count: usize,
}

impl<'a, P: TwoDimensionalPoint> FaceHalfedgeIter<'a, P> {
    pub(crate) fn new(
        face_id: FaceID,
        connectivity_info: &'a ConnectivityInfo<P>,
    ) -> FaceHalfedgeIter<'a, P> {
        FaceHalfedgeIter {
...
impl<'a, P: TwoDimensionalPoint> Iterator for FaceHalfedgeIter<'a, P> {
    type Item = HalfEdgeID;
...
pub struct EdgeIter<'a, P: TwoDimensionalPoint> {
    walker: Walker<'a, P>,
    iter: HalfEdgeIter,
}

impl<'a, P: TwoDimensionalPoint> EdgeIter<'a, P> {
    pub(crate) fn new(connectivity_info: &'a ConnectivityInfo<P>) -> EdgeIter<'a, P> {
        EdgeIter {
...
impl<'a, P: TwoDimensionalPoint> Iterator for EdgeIter<'a, P> {
    type Item = HalfEdgeID;
...
impl<P: TwoDimensionalPoint> Mesh<P> {
    ...
    /// ```
    ///
    pub fn edge_iter(&self) -> EdgeIter<P> {
    ...
    /// ```
    ///
    pub fn vertex_halfedge_iter(&self, vertex_id: VertexID) -> VertexHalfedgeIter<P> {
    ...
    /// ```
    ///
    pub fn face_halfedge_iter(&self, face_id: FaceID) -> FaceHalfedgeIter<P> {
